...
public class SystemUtil {
    ...
    public static String getMacAddress() {
        ...
        try {
            ...
            mac = info.getMacAddress().replaceAll(":", "").toUpperCase();
        } catch (Exception e) {
            LogUtil.e(e);
        }
        return mac;
    ...
    /**
     * 获取WIFI状态: 1.WIFI_STATE_DISABLED : WIFI网卡不可用（1） 2.WIFI_STATE_DISABLING :
     * WIFI网卡正在关闭（0） 3.WIFI_STATE_ENABLED : WIFI网卡可用（3） 4.WIFI_STATE_ENABLING :
     * WIFI网正在打开（2） （WIFI启动需要一段时间） 5.WIFI_STATE_UNKNOWN : 未知网卡状态 目前仅使用1、3、5三种状态
     */
     ...
     * @param msec 毫秒
     */
    public static void setScreenOffTimeOut(int msec) {
        Context context = UIUtil.getContext();
     ...
     * @param enable
     */
    public static void setAutoRotateScreen(boolean enable) {
        Context context = UIUtil.getContext();
     ...
     * @param enable
     */
    public static void setAwakeWhileCharging(boolean enable) {
        Context context = UIUtil.getContext();
        // int stayOn = Settings.System.getInt(mContext.getContentResolver(),
        ...
        Settings.System.putInt(context.getContentResolver(),
                ...
                enable ? (BatteryManager.BATTERY_PLUGGED_AC | BatteryManager.BATTERY_PLUGGED_USB)
                        : 0);
    }
